  ...
  return (
    <>
      ...
      <div className='blog-div'>
        ...
        <ImageWithText image={images('./SLP.png')} text='Structure of SLP' width='400px'/>
        ...
        <ImageWithText image={images('./MSE.png')} text='Mean Squared Error loss function' width='400px' />
        ...
        <img src={images('./Loss_Derivative_Simplified.png')} alt="Loss_Derivative_Simplified" />

        <p>A technique called <i>Backpropagation</i> is used to efficiently calculate the derivative of the loss function for each weight. Once the derivative of the Loss function has been calculated, the weights can be adjusted.</p>

        <img src={images('./Weight_Update.png')} alt="Weight_Update" />
